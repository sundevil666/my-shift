...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'patterns', redirect: { path: '/settings', query: { tab: 'patterns' } } },
      { path: 'reminders', redirect: { path: '/settings', query: { tab: 'reminders' } } },
      { path: 'alarms', redirect: { path: '/settings', query: { tab: 'reminders' } } },
